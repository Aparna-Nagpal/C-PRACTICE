"""
THE OLD SAINT AND THREE QUESTIONS difficulty rating:954
...
The first line of each test case consists of three space-separated integers A1,A2,A3,representing the correct answers to the first, second, and third question respectively (0 for 'No',  for 'Yes').
